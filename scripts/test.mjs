...
try{
 ...
 const result=spawnSync(process.execPath,['--test',join(root,'tests/history.test.js'),join(root,'tests/diagnostics.test.js'),join(root,'tests/comparison.test.js'),join(root,'tests/research.test.js'),join(root,'tests/research-api.test.js')],{stdio:'inherit'});process.exitCode=result.status??1;
