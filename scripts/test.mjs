...
try{
 for(const file of ['lib/market-diagnostics.ts','tests/diagnostics.test.ts','lib/balta-model.ts','lib/market-calendar.ts','lib/market-history-model.ts','lib/kis-history.ts','lib/balta-data.ts','lib/market-history-data.ts','lib/market.ts','app/api/market/live/route.ts','tests/history.test.ts']){
 ...
 const result=spawnSync(process.execPath,['--test',join(root,'tests/history.test.js'),join(root,'tests/diagnostics.test.js')],{stdio:'inherit'});process.exitCode=result.status??1;
